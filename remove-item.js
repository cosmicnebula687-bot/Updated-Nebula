...
module.exports = {
  data: new SlashCommandBuilder()
    .setName('remove-item')
    .setDescription('🗑️ Remove an item from a user inventory')
    .addUserOption(opt =>
      opt
        .setName('user')
        .setDescription('User to remove item from')
        .setRequired(true)
    )
    .addStringOption(opt =>
      opt
      ...
      return interaction.reply({
        embeds: [
          new EmbedBuilder()
            ...
            .setTitle('❌ Item Not In Inventory')
            .setDescription(
              `**${target.username}** does not have **${itemId}**.`
            )
