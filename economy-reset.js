    ...
    const msg = await interaction.reply({
      embeds: [
        new EmbedBuilder()
          ...
          .setDescription(
            `Are you sure you want to reset **${target.username}**'s economy data?\n\nThis will wipe their wallet, bank, inventory, XP, level, and gambling stats.`
          )
        ...
        await i.update({
          embeds: [
            new EmbedBuilder()
              ...
              .setDescription(
                `**${target.username}**'s economy has been reset.`
              )
              .setFooter({ text: '🌌 Nebula Bot' })
              .setTimestamp(),
          ],
